...
export const translations: Record<Language, any> = {
  es: {
    ...
    register: {
        ...
        submit: "CREAR CUENTA",
        terms: "Al crear esta cuenta estás aceptando los términos y condiciones",
  ...
  en: {
    ...
    register: {
        ...
        terms: "By creating this account you are accepting the terms and conditions",
  ...
  pt: {
    ...
    register: {
        title: "Criar Conta",
        subtitle: "Junte-se à batalha",
        username: "Nome de Usuário",
        email: "E-mail",
        password: "Senha",
        confirmPass: "Confirmar Senha",
        submit: "CRIAR CONTA",
        terms: "Ao criar esta conta, você aceita os termos e condições",
