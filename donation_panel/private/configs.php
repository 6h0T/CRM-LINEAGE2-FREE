...
##                   Configuración                       ##
###########################################################
$server_name = 'L2Server'; // Server Nombre
$server_chronicle = 'Scions of Destiny'; // Server Chronicle
$server_url = 'L2server.com.ar'; // Introduzca exactamente la URL donde se encuentra este site (por ejemplo: www.l2server.com)
...
# ¿Qué método de conexión utilizará?
$conMethod = 2; // 1 = MsSQL, 2 = SQLSRV, 3 = ODBC, 4 = PDO-ODBC

# DB Auth
$dbnm['DB'] = 'lin2db'; // Nombre del banco (generalmente lin2db)
$host['DB'] = 'serverl2.ddns.net'; // Host/IP
$port['DB'] = 1433; // Host Port (estándar: 1433)
$user['DB'] = 'sa'; // Usuario
$pass['DB'] = 'Server2025'; // Contraseña

# DB World
$dbnm['WORLD'] = 'lin2world'; // Nombre del banco (geralmente lin2world)
$host['WORLD'] = 'serverl2.ddns.net'; // Host/IP
$port['WORLD'] = 1433; // Host Port (estándar: 1433)
$user['WORLD'] = 'sa'; // Usuario
$pass['WORLD'] = 'Server2025'; // Contraseña

# DB Site
$dbnm['SITE'] = 'lin2site'; // Nombre del banco (geralmente lin2site)
$host['SITE'] = 'serverl2.ddns.net'; // Host/IP
$port['SITE'] = 1433; // Host Port (estándar: 1433)
$user['SITE'] = 'sa'; // Usuario
$pass['SITE'] = 'Server2025'; // Contraseña


###########################################################
##                    Server Status                      ##
###########################################################
$serverIp = 'serverl2.ddns.net'; // Server IP (para buscar el estado del servidor)
...
$forceLoginStatus = 'auto'; // Auth Status (estándar: auto)
$forceGameStatus = 'auto'; // Game Status (estándar: auto)


###########################################################
##                        CacheD                         ##
###########################################################
$cachedIP = 'serverl2.ddns.net'; // ¿Cuál es el IP del dedicado donde está CacheD?
$cachedPort = 2012; // ¿Cuál es la puerta de CacheD? (estándar: 2012)


###########################################################
##              Atualstudio Web Admin 3.0                ##
###########################################################
$admpass = 'test1235545454'; // Contraseña del panel admin


###########################################################
##              Configuración del e-mail                 ##
###########################################################
$admin_email = 'admin@l2server.com.ar'; // E-mail que los jugadores pueden utilizar para ponerse en contacto
$server_email = 'no-reply@l2server.com.ar'; // E-mail utilizado para enviar mensajes automáticas (por ejemplo: no-reply@suservidor.com)
...
$SMTP_host = 'smtp.seusite.com'; // Host SMTP
...
$SMTP_user = 'no-reply@l2server.com.ar'; // Usuario de autenticación SMTP (generalmente el correo electrónico remitente)
...
##                 Registro de Cuentas                   ##
###########################################################
$suffixActive = 0; // Activar sufijo en el login? (método de seguridad que añade 3 valores aleatorios en el login del usuario, para evitar el robo de cuentas a través de listas de login con contraseñas que otros administradores tienen) (1 = Sí | 0 = No)
...
$fakePlayers = 2.0; // Multiplicación de la cantidad de jugadores online. La cantidad de jugadores online se multiplicará por el valor introducido aquí. (1.0 = Cantidad real / 1.5 = multiplicado por 1.5 / 2.0 = multiplicado por 2 ...) - IMPORTANTE: INSERA PUNTO AL EN VEZ DE COMA/VIRGULA
...
$facePage = 'https://www.facebook.com/l2server/'; // Página en Facebook
...
$coinCur = 'ARS$'; // Moneda de esa cantidad
...
$gmt = '0'; // Si los scripts del site están en una hora temprana o retrasada, cambie el GMT. Ejemplo: -1 (-1 hora), +3 (+3 horas), etc
