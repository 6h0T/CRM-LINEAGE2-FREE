...
$LANG[40000] = "<br /><br />Cada ".$coinGame." tiene un valor de 30 Pesos argentinos. Puede conseguir un descuento utlizando el metodo 'Transaccíon Bancaria' en dicho metodo el costo de cada ".$coinGame." tiene un valor de 30 Pesos argentinos.";
...
$LANG[40046] = "Seleccione el personaje que tiene el item que desea encantar.";
$LANG[40047] = "Por favor, espere la carga de los elementos de otro personaje que seleccionó anteriormente. Si está tomando demasiado tiempo, vuelva a cargar la página (F5).";
$LANG[40048] = "No se pudo cargar itemlist! Por favor, informar a los administradores.";
$LANG[40049] = "Usted no tiene permiso para encantar este item!";
$LANG[40050] = "No es permitido reducir el enchant de un item!";
$LANG[40051] = "Introduzca un valor diferente de lo actual enchant!";
$LANG[40052] = "Registre su cuenta en el <a href='%s' target='_blank'>foro</a>! Todas las cuentas se deben resolver con el mismo nombre del personaje en el juego. El nombre del personaje se utiliza como nombre de usuario en el foro.";
$LANG[40053] = "Ya existe una cuenta registrada en el foro con el nombre de este personaje!";
$LANG[40054] = "Su cuenta en el foro se ha registrado correctamente!<br /> Ahora sólo tiene que entrar, haga <a href='%s' target='_blank'>clic aquí</a>.";
$LANG[40055] = "Al registrarse usted declara que ha leído y estoy de acuerdo con todas <a href='%s' target='_blank'>nuestras condiciones</a>.";
$LANG[40056] = "Sus ".strtolower($coinName_mini)."'s (<b>in-game</b>) serán eliminados de su carácter y de convertir en ".strtolower($coinName_mini)."'s (<b>online</b>) y se pueden utilizar para disfrutar de las ventajas y funciones de este panel de usuario.";
$LANG[40057] = "Las transferencias a panel de usuario (in-game para online)";
$LANG[40058] = "Este personaje ya tiene status nobless!";
$LANG[40059] = "Concede el status AIO al personaje seleccionado.";
$LANG[40060] = "El personaje se convertirá en un AIO, recibiendo muchos skills buffers. Sólo tienes que seleccionar abajo la periodicidad deseada. Si ya tiene el AIO status, la periodicidad seleccionada se añade a la que ya tiene.";
$LANG[40061] = "Abajo se muestran todos los jugadores que tienen Boss Jewels.";
$LANG[40062] = "Abajo se muestran los jugadores con mayor level y experiencia.";
$LANG[40063] = "Abajo se muestran los jugadores que tienen más Adena.";
...
$LANG[39055] = "Este personaje tiene actualmente el status %s hasta ";
...
$LANG[39065] = "Concede el status de héroe al personaje seleccionado.";
$LANG[39066] = "Él recibirá un aura, una serie de habilidades especiales y se puede disfrutar de varias ventajas en el juego.";
$LANG[39067] = "Período";
...
$LANG[39070] = "Concede el status VIP al personaje seleccionado.";
...
$LANG[10045] = "<b>Importante:</b> ADJUNTAR COMPROBANTE YA ABONADO Y USUARIO PARA LA CORRESPONDIENTE ENTREGA! ESTO SE ENVIA A LA FANPAGE DEL SERVIDOR.";
...
$LANG[15003] = "Transferencia ($30 ARS = 1 Donation Coin)";
$LANG[15004] = '<a href="https://www.facebook.com/L2FenixCom" target="_blank" style="padding: 10px; background-color: #007bff; color: white; border-radius: 5px; text-decoration: none;">ENVIAR COMPROBANTE</a>';

$LANG[15005] = "Depósito o transferencia a la siguiente cuenta bancaria";

// Vote Reward System
$LANG[50001] = "Vote Reward";
$LANG[50002] = "Votar";
$LANG[50003] = "¡Ayuda a nuestro servidor votando en los topsites! Por cada voto recibirás una recompensa en ".$coinName_mini."'s.";
$LANG[50004] = "Recompensa por voto";
$LANG[50005] = "Total de votos";
$LANG[50006] = "Total ganado";
$LANG[50007] = "Topsites Disponibles";
$LANG[50008] = "Topsite";
$LANG[50009] = "Recompensa";
$LANG[50010] = "Estado";
$LANG[50011] = "Acción";
$LANG[50012] = "Disponible";
$LANG[50013] = "Votar";
$LANG[50014] = "Reclamar";
$LANG[50015] = "Esperar";
$LANG[50016] = "No hay topsites configurados.";
$LANG[50017] = "Primero haz clic en 'Votar' para ir al topsite, vota allí, y luego regresa y haz clic en 'Reclamar' para recibir tu recompensa.";
$LANG[50018] = "Historial de Votos";
$LANG[50019] = "Verificando...";
$LANG[50020] = "Error de conexión. Intenta nuevamente.";
$LANG[50021] = "Fecha";
$LANG[50022] = "Estado";
$LANG[50023] = "Entregado";
$LANG[50024] = "Pendiente";
$LANG[50025] = "Aún no has votado en ningún topsite.";
$LANG[50026] = "Volver a Votar";
