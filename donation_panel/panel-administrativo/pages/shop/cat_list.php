...
<section class="content">
	...
	<div class='box-footer'>
		<a href='?page=cat_add&module=shop' class='btn btn-primary'>Crear nueva categoría</a>
	</div>
	...
	<div class="box">
		...
		<div class="box-body">
			...
			<table class="table table-bordered item-list ui-sortable">
				...
				if(count($consulta) == 0) {
					echo'<tr><td colspan="3">Ninguna categoría encontrada.</td></tr>';
				} else {
					for($i =0, $c=count($consulta);$i < $c; $i++) {
						...
						<tr id='item_".$consulta[$i]['scat_id']."'>
							...
							<td class='opcs'>
								...
								<a href='?page=pack_list&module=shop&cat=".$consulta[$i]['scat_id']."&catnome=".base64_encode($consulta[$i]['nome'])."' class='btn btn-default'>Visualizar Paquetes</a>
								<a href='?page=cat_delete&module=shop&cat=".$consulta[$i]['scat_id']."' title='Borrar' class='btn btn-danger'><i class='fa fa-remove'></i></a>
							</td>
						</tr>
						";
					}
