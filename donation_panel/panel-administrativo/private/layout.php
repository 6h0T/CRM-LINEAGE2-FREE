			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview<?php echo ($m == 'donate/' ? ' active' : ''); ?>">
						<a href="#"><i class="fa fa-money"></i> <span>Donaciones</span> <i class="fa fa-angle-left pull-right"></i></a>
						<ul class="treeview-menu">
							<li><a href='?page=list_all&module=donate'>Ver Donaciones</a></li>
							<li><a href='?page=list_pending&module=donate'>Donaciones Pendientes</a></li>
							<li><a href='?page=list_relat&module=donate'>Informes</a></li>
							<li><a href='?page=balance_list&module=donate'>Ver Saldos</a></li>
							<li><a href='?page=balance_add&module=donate'>Añadir Saldo</a></li>
						</ul>
					</li> 
					...
					<li class="treeview<?php echo ($m == 'shop/' ? ' active' : ''); ?>">
						...
						<ul class="treeview-menu">
							<li><a href='?page=cat_list&module=shop'>Ver Categorías</a></li>
							<li><a href='?page=cat_add&module=shop'>Crear Categoría</a></li>
							<li><a href='?page=pack_list&module=shop'>Ver Paquetes</a></li>
							<li><a href='?page=pack_add&module=shop'>Crear Pacote</a></li>
							<li><a href='?page=item_add&module=shop'>Añadir Item</a></li>
						</ul>
					</li>
					...
					<li class="treeview<?php echo ($m == 'news/' ? ' active' : ''); ?>">
						...
						<ul class="treeview-menu">
							<li><a href='?page=list&module=news'>Ver Noticias</a></li>
							<li><a href='?page=add&module=news'>Añadir Noticia</a></li>
						</ul>
					</li>
					...
					<li class="treeview<?php echo ($m == 'banners/' ? ' active' : ''); ?>">
						...
						<ul class="treeview-menu">
							<li><a href='?page=list&module=banners'>Ver Banners</a></li>
							<li><a href='?page=add&module=banners'>Añadir Banner</a></li>
						</ul>
					</li>
					...
					<li class="treeview<?php echo ($m == 'gallery/' ? ' active' : ''); ?>">
						...
						<ul class="treeview-menu">
							<li><a href='?page=list&module=gallery'>Ver Galeria <?php echo ($countNotifis > 0 ? "(".$countNotifis.")" : ""); ?></a></li>
							<li><a href='?page=addimg&module=gallery'>Añadir Imagen</a></li>
							<li><a href='?page=addvideo&module=gallery'>Añadir Vídeo</a></li>
						</ul>
					</li>
					...
					<li class="treeview<?php echo ($m == 'logs/' ? ' active' : ''); ?>">
						...
						<ul class="treeview-menu">
							...
							<li><a href='?page=donate&module=logs'>Donaciones</a></li>
							<li><a href='?page=services&module=logs'>Servicios</a></li>
							<li><a href='?page=admin&module=logs'>Admin</a></li>
						</ul>
					</li>

					<li>
						<a href="../"><i class="fa fa-reply"></i> <span>Su site</span></a>
					</li> 

					<li>
						<a href="./?logout"><i class="fa fa-lock"></i> <span>Salir</span></a>
					</li> 
